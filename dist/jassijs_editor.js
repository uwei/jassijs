...
define("jassijs_editor/CodePanel", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Panel", "jassijs/base/Router", "jassijs/ui/Notify"], function (require, exports, Registry_1, Panel_1, Router_1, Notify_1) {
    "use strict";
    var CodePanel_1;
...
define("jassijs_editor/util/Typescript", ["require", "exports", "jassijs/remote/Registry", "jassijs/remote/Server", "jassijs_editor/ext/monaco"], function (require, exports, Registry_2, Server_1) {
    "use strict";
    var Typescript_1;
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    */
    ...
    Typescript = Typescript_1 = __decorate([
        (0, Registry_2.$Class)("jassijs_editor.util.Typescript"),
...
define("jassijs_editor/util/TSSourceMap", ["require", "exports", "jassijs/ext/sourcemap", "jassijs/remote/Server", "jassijs/remote/Registry"], function (require, exports, sourcemap_1, Server_2, Registry_3) {
    ...
    let TSSourceMap = class TSSourceMap {
        ...
        async getLinesFromJS(jsfile, data) {
            ...
            if (jscode.indexOf("//" + "# sourceMappingURL=data:application") > -1) {
                ...
                mapcode = await new Server_2.Server().loadFile(mapfile);
            }
            else
                return undefined;
            sourcemap_1.default.SourceMapConsumer.initialize({
    ...
    TSSourceMap = __decorate([
        (0, Registry_3.$Class)("jassijs_editor.util.TSSourceMap")
    ], TSSourceMap);
...
define("jassijs_editor/ErrorPanel", ["require", "exports", "jassijs/ui/Panel", "jassijs/base/Errors", "jassijs/remote/Registry", "jassijs/ui/Button", "jassijs/base/Router", "jassijs/base/Actions", "jassijs/ui/Notify", "jassijs/ui/Component"], function (require, exports, Panel_2, Errors_1, Registry_4, Button_1, Router_2, Actions_1, Notify_2, Component_1) {
    ...
    let ErrorPanel = class ErrorPanel extends Panel_2.Panel {
        /**
     * shows errors
     ...
     */
        ...
        static async showDialog() {
            Router_2.router.navigate("#do=jassijs.ui.ErrorPanel");
        }
        layout() {
            var _this = this;
            if (this.withControls) {
                ...
                this.IDToolbar = new Panel_2.Panel();
         ...
         **/
        async search() {
            var typescript = (await new Promise((resolve_2, reject_2) => { require(["jassijs_editor/util/Typescript"], resolve_2, reject_2); })).default;
        ...
        async _convertURL(url) {
            ...
            if (aurl.length >= 3) {
                ...
                if (u.indexOf("/js/") > -1 || ismodul) {
                    try {
                        //@ts-ignore
                        var TSSourceMap = (await new Promise((resolve_3, reject_3) => { require(["jassijs_editor/util/TSSourceMap"], resolve_3, reject_3); })).TSSourceMap;
    ...
    ErrorPanel = __decorate([
        ...
        (0, Registry_4.$Class)("jassijs_editor.ui.ErrorPanel"),
...
define("jassijs_editor/MonacoPanel", ["require", "exports", "jassijs/remote/Registry", "jassijs/base/Router", "jassijs_editor/util/Typescript", "jassijs_editor/CodePanel", "jassijs/remote/Settings", "jassijs/base/CurrentSettings", "jassijs_editor/Debugger", "jassijs_editor/ext/monaco"], function (require, exports, Registry_5, Router_3, Typescript_2, CodePanel_2, Settings_1, CurrentSettings_1) {
    ...
    function __init(editor) {
        ...
        CommandsRegistry.registerCommand("autoimport", (o1, model, pos) => {
            ...
            var p = Typescript_2.default.getPositionOfLineAndCharacter(file, {
                line: pos.lineNumber, character: pos.column
            });
            const oldpos = model["lastEditor"].getPosition();
            setTimeout(() => {
                CodePanel_2.CodePanel.getAutoimport(p, file, code).then((data) => {
                    if (data !== undefined) {
        ...
        editorService.openCodeEditor = async (input, source) => {
            ...
            if (result === null) {
                ...
                Router_3.router.navigate("#do=jassijs_editor.CodeEditor&file=" + file + "&line=" + line);
            }
        ...
        monaco.languages.registerCompletionItemProvider('typescript', {
            provideCompletionItems: async function (model, position) {
                ...
                var file = model.uri.path.substring(1);
                var pos = Typescript_2.default.getPositionOfLineAndCharacter(file, { line: position.lineNumber, character: position.column });
                var all = await Typescript_2.default.getCompletion(file, pos, undefined, { includeExternalModuleExports: true });
                var sug = [];
    ...
    */
    let MonacoPanel = class MonacoPanel extends CodePanel_2.CodePanel {
        constructor() {
            super();
            var _this = this;
    ...
    MonacoPanel = __decorate([
        (0, Registry_5.$Class)("jassijs_editor.MonacoPanel"),
        __metadata("design:paramtypes", [])
    ], MonacoPanel);
...
define("jassijs_editor/CodeEditor", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Panel", "jassijs_editor/CodePanel", "jassijs/ui/VariablePanel", "jassijs/ui/DockingContainer", "jassijs_editor/ErrorPanel", "jassijs/ui/Button", "jassijs/remote/Registry", "jassijs/remote/Server", "jassijs/util/Reloader", "jassijs/remote/Classes", "jassijs/ui/Component", "jassijs/ui/Property", "jassijs_editor/AcePanel", "jassijs_editor/util/Typescript", "jassijs_editor/MonacoPanel", "jassijs/remote/Settings", "jassijs/remote/Test", "jassijs/base/CurrentSettings", "jassijs/base/Windows", "jassijs/ui/Notify"], function (require, exports, Registry_6, Panel_3, CodePanel_3, VariablePanel_1, DockingContainer_1, ErrorPanel_1, Button_2, Registry_7, Server_3, Reloader_1, Classes_1, Component_2, Property_1, AcePanel_1, Typescript_3, MonacoPanel_1, Settings_2, Test_1, CurrentSettings_2, Windows_1, Notify_3) {
    ...
    CodeEditorSettingsDescriptor = __decorate([
        (0, Settings_2.$SettingsDescriptor)(),
        (0, Registry_6.$Class)("jassijs_editor.CodeEditorSettingsDescriptor")
    ...
    let CodeEditor = CodeEditor_1 = class CodeEditor extends Panel_3.Panel {
        constructor(properties = undefined) {
            ...
            let sett = CurrentSettings_2.currentsettings.gets(Settings_2.Settings.keys.Development_DefaultEditor);
            if (properties === null || properties === void 0 ? void 0 : properties.codePanel) {
                this._codePanel = properties.codePanel;
            }
            else {
                CodePanel_3.CodePanel.typescript = Typescript_3.default;
        ...
        _init(hideToolbar) {
            ...
            if (hideToolbar !== true) {
                ...
                this.autoCompleteButton = new Button_2.Button();
        ...
        async _save(code) {
            var _a;
            await new Server_3.Server().saveFile(this._file, code);
        ...
        */
        ...
        async saveTempFile(file, code) {
            //@ts-ignore 
            var tss = await new Promise((resolve_4, reject_4) => { require(["jassijs_editor/util/Typescript"], resolve_4, reject_4); });
            //@ts-ignore 
            var settings = Object.assign({}, Typescript_3.Typescript.compilerSettings);
        ...
        async evalServerside() {
            var code = this._codePanel.value;
            var testcode = await new Server_3.Server().loadFile(this.file);
            var hasModified = testcode !== code;
            if (hasModified) {
                (0, Notify_3.notify)("please save code before test", "error");
                return undefined;
            }
            var res = await new Server_3.Server().testServersideFile(this._file.substring(0, this._file.length - 3));
            return res;
        }
        /**
    ...
    CodeEditor = CodeEditor_1 = __decorate([
        (0, Registry_6.$Class)("jassijs_editor.CodeEditor"),
...
define("jassijs_editor/ChromeDebugger", ["require", "exports", "jassijs/remote/Registry", "jassijs_editor/Debugger", "jassijs/ui/OptionDialog", "jassijs_editor/util/TSSourceMap", "jassijs/util/Reloader", "jassijs/remote/Server", "jassijs/base/Windows", "jassijs/ui/Notify"], function (require, exports, Registry_8, Debugger_1, OptionDialog_1, TSSourceMap_1, Reloader_2, Server_4, Windows_2, Notify_4) {
    ...
    let ChromeDebugger = ChromeDebugger_1 = class ChromeDebugger extends Debugger_1.Debugger {
        ...
        static showHintExtensionNotInstalled() {
            (0, Notify_4.notifyAddStyle)('downloadlink', {
            ...
            (0, Notify_4.notify)("Jassi Debugger Chrome extension not installed. Click here to download.", { position: "right bottom", style: 'downloadlink', autoHideDelay: 7000 });
        }
        ...
        async saveCode(url, code) {
            ...
            var editor = Windows_2.default.findComponent("jassijs_editor.CodeEditor-" + filename);
            if (editor !== undefined) {
            ...
            new Server_4.Server().saveFile(file, code).then(function () {
                Reloader_2.Reloader.instance.reloadJS(file.replace(".ts", ""));
    ...
    ChromeDebugger = ChromeDebugger_1 = __decorate([
        (0, Registry_8.$Class)("jassijs_editor.ChromeDebugger"),
        __metadata("design:paramtypes", [])
    ], ChromeDebugger);
...
define("jassijs_editor/Debugger", ["require", "exports", "jassijs/remote/Registry"], function (require, exports, Registry_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        */
        ...
        breakpointChanged(file, line, column, enable, type) {
            if (navigator.userAgent.indexOf("Chrome") > -1) {
                (new Promise((resolve_5, reject_5) => { require(["jassijs_editor/ChromeDebugger"], resolve_5, reject_5); })).then((deb) => {
    ...
    Debugger = __decorate([
        (0, Registry_9.$Class)("jassijs_editor.Debugger"),
        __metadata("design:paramtypes", [])
    ], Debugger);
...
define("jassijs_editor/AcePanel", ["require", "exports", "ace/ace", "jassijs_editor/util/Typescript", "jassijs/remote/Registry", "jassijs/remote/Registry", "jassijs_editor/CodePanel", "jassijs/util/Runlater", "jassijs/ui/Component", "ace/ext/language_tools", "jassijs_editor/Debugger"], function (require, exports, ace, Typescript_4, Registry_10, Registry_11, CodePanel_4, Runlater_1, Component_3) {
    ...
    * @class jassijs.ui.CodePanel
    */
    let AcePanel = AcePanel_2 = class AcePanel extends CodePanel_4.CodePanel {
        constructor() {
            super();
            var _this = this;
            ...
            if (this._lastTooltipRefresh + 400 < Date.now()) {
                ...
                Typescript_4.default.getQuickInfoAtPosition(this.file, lpos, this.value).then((p) => {
                    if (p !== undefined) {
                        ...
                        AcePanel_2._tooltipdiv.innerHTML = text;
                        AcePanel_2._tooltipdiv.style["background-color"] = "#f7f4a5";
                        AcePanel_2._tooltipdiv.style.display = "block";
                        AcePanel_2._tooltipdiv.style.position = "absolute";
                        AcePanel_2._tooltipdiv.style.top = event.y + "px";
                        AcePanel_2._tooltipdiv.style.left = event.x + "px";
                    }
                });
            }
        }
        ...
        _manageTooltip(event) {
            if (AcePanel_2._tooltipdiv === undefined) {
                AcePanel_2._tooltipdiv = Component_3.Component.createHTMLElement('<div id="tt">hallo</div>');
                document.body.append(AcePanel_2._tooltipdiv);
            }
            if (event !== undefined) {
                AcePanel_2._tooltipdiv.style.display = "none";
                AcePanel_2._tooltipdiv.style.position = "absolute";
                AcePanel_2._tooltipdiv.style.top = event.y + "px";
                AcePanel_2._tooltipdiv.style.left = event.x + "px";
            }
        ...
        _doRequiredImports(pos, name) {
            ...
            if (this.value.indexOf("import " + name + " ") === -1 && this.value.indexOf("import {" + name + "} ") === -1) {
                ...
                CodePanel_4.CodePanel.getAutoimport(lpos, this.file, this.value).then((data) => {
                    if (data !== undefined) {
        ...
        */
        getDocTooltip(item) {
            if (item.file === undefined)
                return "";
            var _id = "j" + Registry_11.default.nextID();
    ...
    AcePanel = AcePanel_2 = __decorate([
        (0, Registry_10.$Class)("jassijs.ui.AcePanel"),
        __metadata("design:paramtypes", [])
    ], AcePanel);
...
define("jassijs_editor/AcePanelSimple", ["require", "exports", "ace/ace", "jassijs/remote/Registry", "jassijs_editor/CodePanel", "ace/ext/language_tools"], function (require, exports, ace, Registry_12, CodePanel_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    * @class jassijs.ui.CodePanel
    */
    let AcePanelSimple = class AcePanelSimple extends CodePanel_5.CodePanel {
        constructor() {
            super();
            var _this = this;
            var test = '<div class="CodePanel" style="height: 500px; width: 500px"></div>';
    ...
    AcePanelSimple = __decorate([
        (0, Registry_12.$Class)("jassijs.ui.AcePanelSimple"),
        __metadata("design:paramtypes", [])
    ], AcePanelSimple);
...
define("jassijs_editor/CodeEditorInvisibleComponents", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Panel", "jassijs/remote/Registry", "jassijs/ui/Button", "jassijs/remote/Classes", "jassijs/ui/Image"], function (require, exports, Registry_13, Panel_4, Registry_14, Button_3, Classes_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let CodeEditorInvisibleComponents = class CodeEditorInvisibleComponents extends Panel_4.Panel {
        ...
        update() {
            ...
            for (var x = 0; x < elements.length; x++) {
                ...
                //search icon
                Registry_14.default.getJSONData("$UIComponent").then((regdata) => {
...
define("jassijs_editor/ComponentExplorer", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Panel", "jassijs/ui/Tree", "jassijs/ui/ComponentDescriptor", "jassijs/ui/ContextMenu", "jassijs/ui/PropertyEditor", "jassijs/remote/Classes"], function (require, exports, Registry_15, Panel_5, Tree_1, ComponentDescriptor_1, ContextMenu_1, PropertyEditor_1, Classes_3) {
    ...
    ComponentExplorer = __decorate([
        (0, Registry_15.$Class)("jassijs_editor.ComponentExplorer"),
    ...
    async function test() {
        ...
        dlg.getComponentName = function (item) {
            return Classes_3.classes.getClassName(item);
        };
        dlg.value = dlg;
        return dlg;
    }
...
define("jassijs_editor/ComponentPalette", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Panel", "jassijs/ui/Image", "jassijs/remote/Registry", "jassijs/remote/Classes", "jassijs/ext/jquerylib"], function (require, exports, Registry_16, Panel_6, Image_1, Registry_17, Classes_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let ComponentPalette = class ComponentPalette extends Panel_6.Panel {
        ...
        set service(value) {
            ...
            Registry_17.default.getJSONData(this._service).then((jdata) => {
    ...
    ComponentPalette = __decorate([
        (0, Registry_16.$Class)("jassijs_editor.ComponentPalette"),
        __metadata("design:paramtypes", [])
    ], ComponentPalette);
...
define("jassijs_editor/util/DragAndDropper", ["require", "exports", "jassijs/remote/Registry", "jassijs/ext/jquerylib"], function (require, exports, Registry_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    DragAndDropper = __decorate([
        (0, Registry_18.$Class)("jassijs_editor.util.DragAndDropper"),
        __metadata("design:paramtypes", [])
    ], DragAndDropper);
    exports.DragAndDropper = DragAndDropper;
});
define("jassijs_editor/util/Resizer", ["require", "exports", "jassijs/remote/Registry", "jassijs/ext/jquerylib"], function (require, exports, Registry_19) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("jassijs_editor/ComponentDesigner", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Panel", "jassijs/ui/PropertyEditor", "jassijs_editor/ComponentExplorer", "jassijs_editor/ComponentPalette", "jassijs_editor/util/Resizer", "jassijs_editor/CodeEditorInvisibleComponents", "jassijs/ui/Repeater", "jassijs/ui/Button", "jassijs_editor/util/DragAndDropper", "jassijs/ui/ComponentDescriptor", "jassijs/remote/Classes", "jassijs/ui/BoxPanel", "jassijs/ui/Databinder"], function (require, exports, Registry_20, Panel_7, PropertyEditor_2, ComponentExplorer_1, ComponentPalette_1, Resizer_1, CodeEditorInvisibleComponents_1, Repeater_1, Button_4, DragAndDropper_1, ComponentDescriptor_2, Classes_5, BoxPanel_1) {
    ...
    let ComponentDesigner = class ComponentDesigner extends Panel_7.Panel {
        constructor() {
            super();
        ...
        set codeEditor(value) {
            ...
            this._propertyEditor = new PropertyEditor_2.PropertyEditor(value, undefined);
        ...
        _initDesign() {
            var _this = this;
            this._designToolbar = new Panel_7.Panel();
            this._designPlaceholder = new Panel_7.Panel();
            this.editButton = new Button_4.Button();
            ...
            this.saveButton = new Button_4.Button();
            ...
            this.undoButton = new Button_4.Button();
            ...
            this.lassoButton = new Button_4.Button();
            ...
            this.cutButton = new Button_4.Button();
            ...
            this.copyButton = new Button_4.Button();
            ...
            this.pasteButton = new Button_4.Button();
            ...
            box.horizontal = true;
            this.inlineEditorPanel = new Panel_7.Panel();
       ...
       */
        ...
        copyProperties(clip, component) {
            ...
            clip.types[varname] = Classes_5.classes.getClassName(component);
            if (!clip.properties[varname]) {
                clip.properties[varname] = {};
            }
            var editorfields = {};
            (_a = ComponentDescriptor_2.ComponentDescriptor.describe(component.constructor)) === null || _a === void 0 ? void 0 : _a.fields.forEach((f) => { editorfields[f.name] = f; });
        ...
        async pasteComponent(clip, target, before, varname, variablelistold, variablelistnew) {
            ...
            if (clip.properties[varname] !== undefined && clip.properties[varname]["_new_"] !== undefined) {
                ...
                await Classes_5.classes.loadClass(clip.types[varname]);
        ...
        */
        ...
        createComponent(type, component, top, left, newParent, beforeComponent, doUpdate = true, suggestedName = undefined) {
            ...
            var varvalue = new (Classes_5.classes.getClass(type));
    ...
    ComponentDesigner = __decorate([
        (0, Registry_20.$Class)("jassijs_editor.ComponentDesigner"),
        __metadata("design:paramtypes", [])
    ], ComponentDesigner);
...
define("jassijs_editor/ComponentSpy", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Panel", "jassijs/ui/Table", "jassijs/ui/Button", "jassijs/ui/BoxPanel", "jassijs/remote/Classes", "jassijs/base/Actions", "jassijs/base/Router", "jassijs_editor/ErrorPanel", "jassijs/ui/Component"], function (require, exports, Registry_21, Panel_8, Table_1, Button_5, BoxPanel_2, Classes_6, Actions_2, Router_4, ErrorPanel_2, Component_4) {
    ...
    let ComponentSpy = class ComponentSpy extends Panel_8.Panel {
        constructor() {
            ...
            this.hook = undefined;
            var _this = this;
            this.hook = Component_4.Component.onComponentCreated((name, comp) => {
                if (name === "create") {
                    _this.watch(comp);
                }
        ...
        static async showDialog() {
            Router_4.router.navigate("#do=jassijs.ui.ComponentSpy");
        }
        layout() {
            var me = this.me = {};
            ...
            me.IDUpdate = new Button_5.Button();
            me.IDClear = new Button_5.Button();
        ...
        destroy() {
            super.destroy();
            Component_4.Component.offComponentCreated(this.hook);
            this.hook = undefined;
        }
    };
    __decorate([
    ...
    ComponentSpy = __decorate([
        ...
        (0, Registry_21.$Class)("jassijs_editor.ui.ComponentSpy"),
        __metadata("design:paramtypes", [])
    ], ComponentSpy);
...
define("jassijs_editor/util/Tests", ["require", "exports", "jassijs/remote/Registry", "jassijs/base/Actions", "jassijs/ui/Component", "jassijs/ui/BoxPanel", "jassijs/base/Windows", "jassijs/ui/HTMLPanel", "jassijs/base/Errors", "jassijs_editor/ErrorPanel", "jassijs/remote/Test"], function (require, exports, Registry_22, Actions_3, Component_5, BoxPanel_3, Windows_3, HTMLPanel_1, Errors_2, ErrorPanel_3, Test_2) {
                    ...
                    if (text !== undefined) {
                        ...
                        try {
                            if (text.indexOf("export function test(") !== -1 || text.indexOf("export async function test(") !== -1) {
                                ...
                                var func = (_a = (await new Promise((resolve_7, reject_7) => { require([file.fullpath.substring(0, file.fullpath.length - 3)], resolve_7, reject_7); }))) === null || _a === void 0 ? void 0 : _a.test;
                                if (typeof func === "function") {
                                    container.alltests++;
                                    container.update();
                                    var ret = await func(new Test_2.Test());
                                    if (ret instanceof Component_5.Component) {
    ...
    TestAction = TestAction_1 = __decorate([
        ...
        (0, Registry_22.$Class)("jassijs_editor.ui.TestAction")
    ], TestAction);
...
define("jassijs_editor/util/Parser", ["require", "exports", "jassijs/remote/Registry", "jassijs_editor/util/Typescript", "jassijs/remote/Test", "jassijs/remote/Classes"], function (require, exports, Registry_23, Typescript_5, Test_3, Classes_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let Parser = class Parser {
        ...
        convertArgument(arg) {
            ...
            throw new Classes_7.JassiError("Error type not found");
        }
        parseDecorator(dec) {
    ...
    Parser = __decorate([
        (0, Registry_23.$Class)("jassijs_editor.util.Parser"),
        __metadata("design:paramtypes", [])
    ], Parser);
    ...
    exports.tests = tests;
    async function test() {
        tests(new Test_3.Test());
        await Typescript_5.default.waitForInited;
        var code = Typescript_5.default.getCode("demo/Dialog2.ts");
        var parser = new Parser();
...
define("jassijs_editor/FileExplorer", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Tree", "jassijs/ui/Panel", "jassijs/ui/Textbox", "jassijs/remote/Server", "jassijs/base/Router", "jassijs/base/Actions", "jassijs/ui/OptionDialog", "jassijs/ui/ContextMenu", "jassijs/base/Windows"], function (require, exports, Registry_24, Tree_2, Panel_9, Textbox_1, Server_5, Router_5, Actions_4, OptionDialog_2, ContextMenu_2, Windows_4) {
    ...
    let FileActions = class FileActions {
        static async newFile(all, fileName = undefined, code = "", open = false) {
            ...
            if (fileName === undefined) {
                var res = await OptionDialog_2.OptionDialog.show("Enter file name:", ["ok", "cancel"], undefined, true, ".ts");
        ...
        static async download(all) {
            var path = all[0].fullpath;
            var byteCharacters = atob(await new Server_5.Server().zip(path));
        ...
        static async newFolder(all, filename = undefined) {
            ...
            if (filename) {
                ...
                res = await OptionDialog_2.OptionDialog.show("Enter file name:", ["ok", "cancel"], undefined, true, "");
            if (res.button === "ok" && res.text !== all[0].name) {
        ...
        static async dodelete(all, withwarning = true) {
            ...
            var res;
            if (withwarning) {
                res = await OptionDialog_2.OptionDialog.show("Delete this?<br/>" + s, ["ok", "cancel"], undefined, true);
            }
            if (!withwarning || (res.button === "ok" && res.text !== all[0].name)) {
                var ret = await new Server_5.Server().delete(all[0].fullpath);
                if (ret !== "") {
                    alert(ret);
                    return;
                }
        ...
        static async rename(all, foldername = undefined) {
            ...
            if (all.length !== 1)
                ...
                if (foldername) {
                    ...
                    res = await OptionDialog_2.OptionDialog.show("Enter new name:", ["ok", "cancel"], undefined, true, all[0].name);
                if (res.button === "ok" && res.text !== all[0].name) {
                    ...
                    if (!all[0].isDirectory()) {
                        let tss = (await new Promise((resolve_8, reject_8) => { require(["jassijs_editor/util/" + "Typescript"], resolve_8, reject_8); })).default; //modul jassijs could not comp
    ...
    let FileExplorer = FileExplorer_1 = class FileExplorer extends Panel_9.Panel {
        constructor() {
            super();
        ...
        async refresh() {
            var _a;
            let root = (await new Server_5.Server().dir());
            root.fullpath = "";
            root.name = "client";
            //flag modules
    ...
    FileExplorer = FileExplorer_1 = __decorate([
        ...
        (0, Registry_24.$Class)("jassijs.ui.FileExplorer"),
        __metadata("design:paramtypes", [])
    ], FileExplorer);
...
export async function test(){
    ...
    TemplateDBDialogProperties = __decorate([
        (0, Registry_25.$Class)("jassijs_editor.template.TemplateDBDialogProperties")
    ...
    let TemplateDBDialog = class TemplateDBDialog {
        static async newFile(all) {
            ...
            if (res.button === "ok") {
                ...
                var dbfilename = (await Registry_25.default.getJSONData("$Class", fulldbclassname))[0].filename;
                ...
                FileExplorer_2.FileActions.newFile(all, props.dialogname + ".ts", scode, true);
            }
        }
    };
    ...
    TemplateDBDialog = __decorate([
        ...
        (0, Registry_25.$Class)("jassijs.template.TemplateDBDialog")
    ], TemplateDBDialog);
    exports.TemplateDBDialog = TemplateDBDialog;
});
define("jassijs_editor/template/TemplateDBObject", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Property", "jassijs/base/Actions", "jassijs/ui/OptionDialog", "jassijs_editor/FileExplorer"], function (require, exports, Registry_26, Property_3, Actions_6, OptionDialog_4, FileExplorer_3) {
    "use strict";
...
export async function test() {
    ...
    TemplateDBObjectProperties = __decorate([
        (0, Registry_26.$Class)("jassijs_editor.template.TemplateDBObjectProperties")
    ...
    let TemplateDBObject = TemplateDBObject_1 = class TemplateDBObject {
        static async newFile(all) {
            ...
            if (res.button === "ok") {
                ...
                FileExplorer_3.FileActions.newFile(all, props.name + ".ts", scode, true);
            }
        }
    };
...
define("jassijs_editor/util/DatabaseSchema", ["require", "exports", "jassijs/remote/Registry", "jassijs/remote/Registry", "jassijs_editor/util/Typescript", "jassijs_editor/util/Parser", "jassijs_editor/template/TemplateDBObject", "jassijs/util/Tools", "jassijs/remote/Server", "jassijs/base/Windows", "jassijs/ui/OptionDialog", "jquery.choosen"], function (require, exports, Registry_27, Registry_28, Typescript_6, Parser_1, TemplateDBObject_2, Tools_1, Server_6, Windows_5, OptionDialog_5) {
    ...
    let DatabaseSchema = DatabaseSchema_1 = class DatabaseSchema {
        ...
        async reloadCodeInEditor(file, text) {
            var editor = Windows_5.default.findComponent("jassijs_editor.CodeEditor-" + file);
            if (editor !== undefined) {
                if (editor._codeToReload === undefined) {
                    var data = await OptionDialog_5.OptionDialog.show("The source was updated in Chrome. Do you want to load this modification?", ["Yes", "No"], editor, false);
                    if (data.button === "Yes")
                        editor.value = text;
                    delete editor._codeToReload;
                }
        ...
        async updateSchema(onlyPreview = false) {
            ...
            if (!onlyPreview) {
                ...
                try {
                    await new Server_6.Server().saveFiles(files, contents);
        ...
        async parseFiles() {
            this.parsedClasses = {};
            this.definedImports = {};
            await Typescript_6.default.waitForInited;
            var data = await Registry_28.default.getJSONData("$DBObject");
            for (let x = 0; x < data.length; x++) {
                var entr = data[x];
                var parser = new Parser_1.Parser();
                var file = entr.filename;
                var code = Typescript_6.default.getCode(file);
                // if (code === undefined)
        ...
        async loadSchemaFromCode() {
            ...
            await Registry_28.default.reload();
            var data = Registry_28.default.getJSONData("$DBObject");
            this.databaseClasses = [];
            var _this = this;
    ...
    DatabaseSchema = DatabaseSchema_1 = __decorate([
        (0, Registry_27.$Class)("jassijs_editor.util.DatabaseSchema")
    ], DatabaseSchema);
...
define("jassijs_editor/DatabaseDesigner", ["require", "exports", "jassijs/ui/BoxPanel", "jassijs/ui/Button", "jassijs/ui/Databinder", "jassijs/ui/Select", "jassijs/ui/Table", "jassijs/remote/Registry", "jassijs/ui/Panel", "jassijs/ui/OptionDialog", "jassijs/base/Router", "jassijs/base/Actions", "jassijs/base/Windows", "jassijs_editor/util/DatabaseSchema"], function (require, exports, BoxPanel_4, Button_6, Databinder_1, Select_1, Table_2, Registry_29, Panel_10, OptionDialog_6, Router_6, Actions_7, Windows_6, DatabaseSchema_2) {
    ...
    let DatabaseDesigner = class DatabaseDesigner extends Panel_10.Panel {
        ...
        static async showDialog() {
            Router_6.router.navigate("#do=jassijs_editor/DatabaseDesigner");
        }
        layout(me, readShema = true) {
            me.newclass = new Button_6.Button();
            me.boxpanel1 = new BoxPanel_4.BoxPanel();
            me.save = new Button_6.Button();
            me.boxpanel2 = new BoxPanel_4.BoxPanel(false);
            me.newfield = new Button_6.Button();
            me.removefield = new Button_6.Button();
            me.boxpanel3 = new BoxPanel_4.BoxPanel();
        ...
        addField(typename = undefined, name = undefined, nullable = undefined, relation = undefined) {
            var field = new DatabaseSchema_2.DatabaseField();
            //@ts-ignore
    ...
    DatabaseDesigner = __decorate([
        ...
        (0, Registry_29.$Class)("jassijs_editor/DatabaseDesigner"),
        __metadata("design:paramtypes", [Object])
    ], DatabaseDesigner);
...
define("jassijs_editor/SearchExplorer", ["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Tree", "jassijs/ui/Panel", "jassijs/ui/Textbox", "jassijs/base/Router", "jassijs/base/Actions", "jassijs/base/Windows"], function (require, exports, Registry_30, Tree_3, Panel_11, Textbox_2, Router_7, Actions_8, Windows_7) {
    "use strict";
    ...
    let SearchExplorer = SearchExplorer_1 = class SearchExplorer extends Panel_11.Panel {
        ...
        async doSearch() {
            var typescript = (await new Promise((resolve_9, reject_9) => { require(["jassijs_editor/util/Typescript"], resolve_9, reject_9); })).default;
            var all = [];
        ...
        async layout() {
            ...
            this.tree.onclick(function (evt) {
                if (evt.data !== undefined && evt.data.file !== undefined) {
                    ...
                    new Promise((resolve_10, reject_10) => { require(["jassijs_editor/util/Typescript"], resolve_10, reject_10); }).then(Typescript => {
    ...
    SearchExplorer = SearchExplorer_1 = __decorate([
        ...
        (0, Registry_30.$Class)("jassijs_editor.ui.SearchExplorer"),
        __metadata("design:paramtypes", [])
    ], SearchExplorer);
...
define("jassijs_editor/StartEditor", ["require", "exports", "jassijs_editor/FileExplorer", "jassijs/base/Windows", "jassijs/ui/Panel", "jassijs/ui/Button", "jassijs/base/Router", "jassijs_editor/SearchExplorer", "jassijs/ui/DBObjectExplorer", "jassijs/ui/ActionNodeMenu"], function (require, exports, FileExplorer_4, Windows_8, Panel_12, Button_7, Router_8, SearchExplorer_2, DBObjectExplorer_1, ActionNodeMenu_1) {
    ...
    async function start() {
        ...
        body.max();
        Windows_8.default.addLeft(new DBObjectExplorer_1.DBObjectExplorer(), "DBObjects");
        Windows_8.default.addLeft(new SearchExplorer_2.SearchExplorer(), "Search");
        Windows_8.default.addLeft(new FileExplorer_4.FileExplorer(), "Files");
        var bt = new Button_7.Button();
        Windows_8.default._desktop.add(bt);
        bt.icon = "mdi mdi-refresh";
        var am = new ActionNodeMenu_1.ActionNodeMenu();
        bt.onclick(() => {
            Windows_8.default._desktop.remove(am);
            am = new ActionNodeMenu_1.ActionNodeMenu();
            Windows_8.default._desktop.add(am);
        });
        Windows_8.default._desktop.add(am);
...
define("jassijs_editor/template/TemplateEmptyDialog", ["require", "exports", "jassijs/base/Actions", "jassijs/remote/Registry", "jassijs/ui/OptionDialog", "jassijs_editor/FileExplorer"], function (require, exports, Actions_9, Registry_31, OptionDialog_7, FileExplorer_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
export async function test(){
    ...
    TemplateEmptyDialog = __decorate([
        ...
        (0, Registry_31.$Class)("jassijs_editor.template.TemplateEmptyDialog")
    ], TemplateEmptyDialog);
    exports.TemplateEmptyDialog = TemplateEmptyDialog;
});
define("jassijs_editor/template/TemplateRemoteObject", ["require", "exports", "jassijs/base/Actions", "jassijs/remote/Registry", "jassijs/ui/OptionDialog", "jassijs_editor/FileExplorer"], function (require, exports, Actions_10, Registry_32, OptionDialog_8, FileExplorer_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
`;
    ...
    TemplateRemoteObject = __decorate([
        ...
        (0, Registry_32.$Class)("jassijs_editor.template.TemplateRemoteObject")
