...
define(["require", "exports", "remote/jassi/base/Jassi", "jassi/ui/Panel", "jassi/ui/VariablePanel", "jassi/ui/DockingContainer", "jassi/ui/ErrorPanel", "jassi/ui/Button", "remote/jassi/base/Registry", "remote/jassi/base/Server", "jassi/util/Reloader", "remote/jassi/base/Classes", "jassi/ui/Component", "jassi/ui/Property", "jassi/base/Tests", "jassi/ui/AcePanel", "jassi/util/Typescript", "jassi/ui/MonacoPanel"], function (require, exports, Jassi_1, Panel_1, VariablePanel_1, DockingContainer_1, ErrorPanel_1, Button_1, Registry_1, Server_1, Reloader_1, Classes_1, Component_1, Property_1, Tests_1, AcePanel_1, Typescript_1, MonacoPanel_1) {
    ...
    let CodeEditor = CodeEditor_1 = class CodeEditor extends Panel_1.Panel {
        ...
        */
                ...
                if (ret !== undefined) {
                    ...
                    if (ret instanceof Component_1.Component && ret["reporttype"] === undefined) {
                        require(["jassi/ui/designer/ComponentDesigner"], function () {
                            var ComponentDesigner = Classes_1.classes.getClass("jassi.ui.designer.ComponentDesigner");
        ...
        async saveTempFile(file, code) {
            //@ts-ignore 
            var tss = await new Promise((resolve_1, reject_1) => { require(["jassi/util/Typescript"], resolve_1, reject_1); });
    ...
    CodeEditor = CodeEditor_1 = __decorate([
        Jassi_1.$Class("jassi.ui.CodeEditor"),
