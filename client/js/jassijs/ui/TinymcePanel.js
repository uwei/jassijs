...
define(["require", "exports", "jassijs/ui/Component", "jassijs/remote/Registry", "jassijs/ui/Property", "jassijs/ui/DataComponent"], function (require, exports, Component_1, Registry_1, Property_1, DataComponent_1) {
    ...
    exports.test = exports.TinymcePanel = void 0;
    var bugtinymce = undefined;
    //@$UIComponent({ fullPath: "common/HTMLPanel", icon: "mdi mdi-cloud-tags" /*, initialize: { value: "text" } */ })
    let TinymcePanel = TinymcePanel_1 = class TinymcePanel extends DataComponent_1.DataComponent {
        /*[
        ...
        render() {
            return (0, Component_1.jc)("div", {
                className: "HTMLPanel mce-content-body", tabIndex: -1, children: [
                    (0, Component_1.jc)("div", { className: "HTMLPanelContent" })
                ]
            });
        }
        config(config) {
    ...
    TinymcePanel = TinymcePanel_1 = __decorate([
        (0, Registry_1.$Class)("jassijs.ui.TinymcePanel"),
        __metadata("design:paramtypes", [Object])
    ], TinymcePanel);
...
//# sourceMappingURL=TinymcePanel.js.map