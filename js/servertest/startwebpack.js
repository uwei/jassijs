...
exports.startWebpack2 = exports.startWebpack = exports.registerWebpack = void 0;
...
exports.registerWebpack = registerWebpack;
async function startWebpack() {
    ...
    const server = http.createServer((req, res) => {
        ...
        const runMiddleware = (middleware, req, res) => new Promise(resolve => middleware(req, res, () => resolve()));
...
exports.startWebpack2 = startWebpack2;
//# sourceMappingURL=startwebpack.js.map