define(["require", "exports", "game/citydialog", "game/company", "game/icons"], function (require, exports, citydialog_1, company_1, icons_1) {
    "use strict";
    ...
    class City {
        ...
        update() {
            ...
            this.domDesc.innerHTML = this.name + "<br/>" + this.people.toLocaleString() + "<br/>" + parameter.allProducts[0].getIcon() + " " + icons_1.Icons.edit;
