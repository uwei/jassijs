...
define(["require", "exports", "jassijs/remote/Registry", "jassijs/ui/Property", "jassijs/base/Actions", "jassijs/ui/OptionDialog", "jassijs_editor/FileExplorer"], function (require, exports, Registry_1, Property_1, Actions_1, OptionDialog_1, FileExplorer_1) {
    "use strict";
...
export async function test() {
    ...
    __decorate([
        (0, Property_1.$Property)({ decription: "name of the db class" }),
        __metadata("design:type", String)
    ], TemplateDBObjectProperties.prototype, "name", void 0);
    __decorate([
        (0, Property_1.$Property)({ default: "true", description: "the primary column alue will be automatically generated with an auto-increment value" }),
        __metadata("design:type", String)
    ], TemplateDBObjectProperties.prototype, "autogeneratedid", void 0);
    TemplateDBObjectProperties = __decorate([
        (0, Registry_1.$Class)("jassijs_editor.template.TemplateDBObjectProperties")
    ...
    TemplateDBObject = TemplateDBObject_1 = __decorate([
        ...
        (0, Registry_1.$Class)("jassijs.template.TemplateDBObject")
    ], TemplateDBObject);
