...
declare module "jassijs/ui/Component" {
    ...
    export class Component<T = {}> implements React.Component<ComponentProperties, {}> {
        ...
        config(config: T, forceRender?: boolean): Component<T>;
        /**
        ...
        */
        init(dom: HTMLElement | string, properties?: T): void;
    ...
    export class HTMLComponent<T extends HTMLComponentProperties = {}> extends Component<HTMLComponentProperties> implements HTMLComponentProperties {
        ...
        config(props: HTMLComponentProperties, forceRender?: boolean): this;
    ...
    export class TextComponent<T extends TextComponentProperties = {}> extends Component<TextComponentProperties> implements TextComponentProperties {
        ...
        get tooltip(): string;
        get hidden(): boolean;
        config(props: TextComponentProperties, forceRender?: boolean): this;
        get text(): string;
...
declare module "jassijs/ui/Container" {
    ...
    export class Container<T extends ContainerProperties = {}> extends Component<T> implements Omit<ContainerProperties, "children"> {
        ...
        config(config: T, forceRender?: boolean): Container<T>;
        /**
        * inits the component
        * @param {dom} dom - init the dom element
        * @paran {object} properties - properties to init
...
declare module "jassijs/ui/Select" {
    ...
    export class Select<T extends SelectProperities = {}> extends DataComponent<SelectProperities> {
        ...
        config(config: SelectProperities): this;
        refresh(): void;
