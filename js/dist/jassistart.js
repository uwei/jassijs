class JassijsStarter {
    constructor() {
        this.runScript = document.currentScript.getAttribute("data-run");
        this.configFile = document.currentScript.getAttribute("data-config");
        this.runFunction = document.currentScript.getAttribute("data-run-function");
        this.cssFiles = {};
    }
