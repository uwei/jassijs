...
define(["require", "exports", "remote/jassi/base/Jassi", "jassi/ui/Tree", "jassi/ui/Panel", "jassi/ui/Textbox", "remote/jassi/base/Server", "jassi/base/Router", "jassi/base/Actions", "jassi/ui/OptionDialog", "jassi/util/Typescript", "jassi/ui/ContextMenu"], function (require, exports, Jassi_1, Tree_1, Panel_1, Textbox_1, Server_1, Router_1, Actions_1, OptionDialog_1, Typescript_1, ContextMenu_1) {
    "use strict";
    var FileExplorer_1;
    ...
    let FileActions = class FileActions {
        static async newFile(all, fileName = undefined, code = "", open = false) {
            ...
            if (open)
                Router_1.router.navigate("#do=jassi.ui.CodeEditor&file=" + newkey.replaceAll("|", "/"));
        }
        ...
        static async open(all) {
            ...
            if (node.isDirectory())
                return;
            Router_1.router.navigate("#do=jassi.ui.CodeEditor&file=" + node.fullpath);
        }
    };
    __decorate([
        Actions_1.$Action({
