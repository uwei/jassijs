...
define("jassijs/remote/Context", ["require", "exports"], function (require, exports) {
    ...
    async function useZoneContext(context, fn, ...args) {
        if (jassijs.isServer) {
            await new Promise((resolve_6, reject_6) => { require(["zone.js"], resolve_6, reject_6); }).then(__importStar);
        }
        else {
            await new Promise((resolve_7, reject_7) => { require(["zone-js"], resolve_7, reject_7); }).then(__importStar);
        }
...
define("jassijs/remote/RemoteObject", ["require", "exports", "jassijs/remote/Registry", "jassijs/remote/Classes", "jassijs/remote/RemoteProtocol", "jassijs/remote/Context"], function (require, exports, Registry_11, Classes_6, RemoteProtocol_1, Context_2) {
    "use strict";
    var RemoteObject_3;
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let RemoteObject = RemoteObject_3 = class RemoteObject {
        ...
        static async docallWithReplaceThis(replaceThis, _this, method, ...parameter) {
            ...
            prot.classname = Classes_6.classes.getClassName(_this);
...
define("jassijs/remote/RemoteTest", ["require", "exports", "jassijs/remote/RemoteObject", "jassijs/remote/Registry"], function (require, exports, RemoteObject_4, Registry_13) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.RemoteTest = RemoteTest = __decorate([
        (0, Registry_13.$Class)("jassijs.remote.RemoteTest")
    ], RemoteTest);
    async function test() {
...
>>>>>>> d240df83ceb960d653afe75fc93bccd1c67e9279
    ...
    function $Rights(rights) {
        return function (pclass) {
            Registry_18.default.register("$Rights", pclass, rights);
        };
    }
    function $ParentRights(rights) {
        return function (pclass) {
            Registry_18.default.register("$ParentRights", pclass, rights);
        };
    }
...
define("jassijs/remote/security/Setting", ["require", "exports", "jassijs/remote/DBObject", "jassijs/remote/Registry", "jassijs/util/DatabaseSchema", "../Classes", "jassijs/remote/Validator"], function (require, exports, DBObject_5, Registry_19, DatabaseSchema_5, Classes_8, Validator_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("jassijs/remote/Server", ["require", "exports", "jassijs/remote/Registry", "jassijs/remote/RemoteObject", "jassijs/remote/FileNode", "./Classes", "./Serverservice", "jassijs/remote/Validator", "./Config"], function (require, exports, Registry_21, RemoteObject_5, FileNode_1, Classes_9, Serverservice_3, Validator_8, Config_3) {
    "use strict";
    var Server_1;
...
<<<<<<< HEAD
    __decorate([
        (0, Validator_8.ValidateFunctionParameter)(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [RemoteObject_5.Context]),
        __metadata("design:returntype", Promise)
    ], Server, "mytest", null);
...
//@ts-ignore
define("jassijs/remote/Serverservice", ["require", "exports", "jassijs/remote/Classes", "jassijs/remote/Registry", "jassijs/remote/Classes"], function (require, exports, Classes_10, Registry_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
<<<<<<< HEAD
    async function resolve(target, prop, receiver) {
        ...
        if (target[prop]) {
            ...
            var all = await Registry_22.default.getJSONData("$Serverservice");
            for (var x = 0; x < all.length; x++) {
                var serv = all[x];
                var name = serv.params[0].name;
                if (name === prop) {
                    var classname = serv.classname;
                    var cl = await Registry_22.default.getJSONData("$Class", classname);
                    //@ts-ignore
                    if (require.main) { //nodes load project class from module
                    ...
                    var props = Registry_22.default.getData("$Serverservice", classname)[0].params[0];
...
>>>>>>> d240df83ceb960d653afe75fc93bccd1c67e9279
    ...
    let Settings = Settings_1 = class Settings extends DBObject_7.DBObject {
        /**
        * loads the settings
        */
    ...
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_a = typeof T !== "undefined" && T) === "function" ? _a : Object, typeof (_b = typeof T !== "undefined" && T) === "function" ? _b : Object, String, RemoteObject_6.Context]),
        __metadata("design:returntype", Promise)
    ], Settings, "save", null);
    __decorate([
        (0, Validator_9.ValidateFunctionParameter)(),
...
>>>>>>> d240df83ceb960d653afe75fc93bccd1c67e9279
    ...
    function $SettingsDescriptor() {
        return function (pclass) {
            Registry_24.default.register("$SettingsDescriptor", pclass);
        };
    }
...
define("jassijs/remote/Transaction", ["require", "exports", "jassijs/remote/Registry", "jassijs/remote/RemoteObject"], function (require, exports, Registry_26, RemoteObject_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
<<<<<<< HEAD
    ...
    exports.TransactionTest = TransactionTest = __decorate([
        (0, Registry_26.$Class)("jassijs.remote.TransactionTest")
    ], TransactionTest);
    async function test(t) {
...
//export function Entity(options?: EntityOptions): Function;
//export declare type PrimaryGeneratedColumnType = "int" | "int2" | "int4" | "int8" | "integer" | "tinyint" | "smallint" | "mediumint" | "bigint" | "dec" | "decimal" | "fixed" | "numeric" | "number" | "uuid";
define("jassijs/server/DBManager", ["require", "exports", "typeorm", "jassijs/remote/Classes", "jassijs/remote/Registry", "jassijs/remote/security/User", "jassijs/remote/Registry", "jassijs/remote/Serverservice"], function (require, exports, typeorm_3, Classes_13, Registry_27, User_2, Registry_28, Serverservice_5) {
    "use strict";
    var DBManager_1;
    Object.defineProperty(exports, "__esModule", { value: true });
...
>>>>>>> d240df83ceb960d653afe75fc93bccd1c67e9279
        ...
        async _checkParentRightsForSave(context, entity) {
            ...
            if (Registry_27.default.getMemberData("$CheckParentRight") !== undefined) {
                var data = Registry_27.default.getMemberData("$CheckParentRight")[Classes_13.classes.getClassName(entity)];
                for (var key in data) {
        ...
        async nologin(context, user, password) {
            try {
                ...
                var us = await this.connection().manager.findOne(User_2.User);
...
define("jassijs/server/DBManagerExt", ["require", "exports", "jassijs/remote/Classes", "jassijs/remote/Database", "jassijs/remote/Registry", "./DBManager", "./TypeORMListener", "typeorm", "./NativeAdapter"], function (require, exports, Classes_14, Database_3, Registry_29, DBManager_2, TypeORMListener_1, typeorm_4, NativeAdapter_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
>>>>>>> d240df83ceb960d653afe75fc93bccd1c67e9279
    function extendDBManager() {
        ...
        DBManager_2.DBManager["getConOpts"] = async function () {
            ...
            var dbobjects = await Registry_29.default.getJSONData("$DBObject");
            var dbfiles = [];
            for (var o = 0; o < dbobjects.length; o++) {
                var clname = dbobjects[o].classname;
                try {
...
define("jassijs/server/DoRemoteProtocol", ["require", "exports", "jassijs/remote/Registry", "jassijs/remote/Classes", "jassijs/remote/Serverservice", "jassijs/remote/Config"], function (require, exports, Registry_30, Classes_15, Serverservice_6, Config_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.remoteProtocol = remoteProtocol;
...
>>>>>>> d240df83ceb960d653afe75fc93bccd1c67e9279
        ...
        var files = Registry_30.default.getAllFilesForService("$Class", prot.classname);
    ...
    let Filesystem = class Filesystem {
        ...
        */
        ...
        async saveFiles(fileNames, contents, rollbackonerror = true) {
            ...
            if (remotecodeincluded) {
                await Registry_31.default.reload();
            }
...
define("jassijs/server/NeverCallMe", ["require", "exports", "typescript"], function (require, exports, TypeScript) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("jassijs/server/Reloader", ["require", "exports", "jassijs/remote/Config", "jassijs/remote/Registry", "jassijs/remote/Registry"], function (require, exports, Config_12, Registry_32, Registry_33) {
    "use strict";
    var Reloader_2;
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let Reloader = Reloader_2 = class Reloader {
        ...
        async reloadJSAll(fileNames, afterUnload = undefined, useServerRequire = false) {
            ...
            for (let ff = 0; ff < fileNames.length; ff++) {
                ...
                var allclasses = await Registry_33.default.getJSONData("$Class");
                var classesInFile = [];
...
debugger;
define("jassijs/server/Testuser", ["require", "exports", "jassijs/util/DatabaseSchema", "jassijs/remote/DBObject", "jassijs/remote/Registry"], function (require, exports, DatabaseSchema_7, DBObject_8, Registry_34) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
