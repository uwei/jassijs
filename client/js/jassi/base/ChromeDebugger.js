...
define(["require", "exports", "remote/jassi/base/Jassi", "jassi/base/Debugger", "jassi/ui/OptionDialog", "jassi/util/TSSourceMap", "jassi/util/Reloader", "remote/jassi/base/Server", "./Windows"], function (require, exports, Jassi_1, Debugger_1, OptionDialog_1, TSSourceMap_1, Reloader_1, Server_1, Windows_1) {
    "use strict";
    ...
    let ChromeDebugger = class ChromeDebugger extends Debugger_1.Debugger {
        ...
        async saveCode(url, code) {
            ...
            var editor = Windows_1.default.findComponent("jassi.ui.CodeEditor-" + filename);
            if (editor !== undefined) {
        ...
        */
        ...
        reportVariables(url, variables, type = undefined) {
            ...
            var file = this.urlToFile(url);
            var _this = this;
            var editor = Jassi_1.default.windows.findComponent("jassi.ui.CodeEditor-" + file);
            if (editor !== undefined) {
    ...
    ChromeDebugger = __decorate([
        Jassi_1.$Class("jassi.base.ChromeDebugger"),
