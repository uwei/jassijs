...
define("jassi_editor/AcePanel", ["require", "exports", "jassi/jassi", "jassi_editor/ext/acelib", "jassi_editor/util/Typescript", "jassi/remote/Jassi", "jassi/remote/Registry", "jassi_editor/CodePanel", "jassi_editor/Debugger"], function (require, exports, jassi_1, acelib_1, Typescript_1, Jassi_1, Registry_1, CodePanel_1) {
    "use strict";
    var AcePanel_1;
...
define("jassi_editor/ChromeDebugger", ["require", "exports", "jassi/remote/Jassi", "jassi_editor/Debugger", "jassi/ui/OptionDialog", "jassi_editor/util/TSSourceMap", "jassi/util/Reloader", "jassi/remote/Server", "jassi/base/Windows"], function (require, exports, Jassi_4, Debugger_1, OptionDialog_1, TSSourceMap_1, Reloader_1, Server_1, Windows_2) {
    ...
    Jassi_4.default.test = function () {
        alert(Jassi_4.default.base.ChromeDebugger.isExtensionInstalled());
        var kk = new Jassi_4.default.base.ChromeDebugger();
    };
    if (ChromeDebugger.isExtensionInstalled()) {
        if (Jassi_4.default.debugger !== undefined)
            Jassi_4.default.debugger.destroy();
        Jassi_4.default.debugger = new ChromeDebugger();
    }
});
    ...
    function __init(editor) {
        ...
        editorService.openCodeEditor = async (input, source) => {
            ...
            if (result === null) {
                ...
                Router_2.router.navigate("#do=jassi_editor.CodeEditor&file=" + file + "&line=" + line);
            }
...
define("jassi_editor/util/TSSourceMap", ["require", "exports", "jassi/ext/sourcemap", "jassi/remote/Jassi"], function (require, exports, sourcemap_1, Jassi_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("jassi_editor/util/Typescript", ["require", "exports", "jassi/remote/Jassi", "jassi/remote/Server", "jassi_editor/ext/monaco", "jassi/ext/requestidlecallback"], function (require, exports, Jassi_19, Server_4) {
    "use strict";
    var Typescript_6;
    Object.defineProperty(exports, "__esModule", { value: true });
...
//# sourceMappingURL=jassi_editor.js.map