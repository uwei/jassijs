...
__decorate([
    Validator_1.ValidateIsInstanceOf({ type: type => Orders_1.Orders }),
...
__decorate([
    Validator_1.ValidateIsInstanceOf({ type: type => Products_1.Products }),
...
OrderDetails = __decorate([
    DBObject_1.$DBObject(),
    Registry_1.$Class("northwind.OrderDetails"),
