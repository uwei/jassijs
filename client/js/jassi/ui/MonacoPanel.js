...
define(["require", "exports", "remote/jassi/base/Jassi", "jassi/base/Router", "jassi/util/Typescript", "remote/jassi/base/Server", "jassi/ui/CodePanel", "jassi/base/Debugger", "jassi/ext/monaco"], function (require, exports, Jassi_1, Router_1, Typescript_1, Server_1, CodePanel_1) {
    "use strict";
    ...
    function __init(editor) {
        ...
        CommandsRegistry.registerCommand("autoimport", (o1, model, pos) => {
            ...
            setTimeout(() => {
                CodePanel_1.CodePanel.getAutoimport(p, file, undefined).then((data) => {
                    if (data !== undefined) {
    ...
    */
    ...
    MonacoPanel = __decorate([
        Jassi_1.$Class("jassi.ui.MonacoPanel"),
