...
const Windows_1 = require("jassijs/base/Windows");
...
let Report = class Report extends RemoteObject_1.RemoteObject {
    ...
    async fill(context = undefined) {
        if (!(context === null || context === void 0 ? void 0 : context.isServer)) {
            ...
            var fill = (await Promise.resolve().then(() => require(this["serverReportPath"]))).fill;
...
Report = __decorate([
    Registry_1.$Class("jassijs_report.remote.Report")
], Report);
exports.Report = Report;
async function test() {
