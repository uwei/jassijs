declare module "jassijs_report/designer/ReportDesigner" {
    ...
    export class ReportDesigner extends HtmlDesigner {
        ...
        createComponent(type: any, component: any, top: any, left: any, newParent: any, beforeComponent: any): any;
...
declare module "jassijs_report/ReportDesign" {
    ...
    export class ReportDesign extends BoxPanel {
        ...
        */
        ...
        static getVariables(component: RComponent): {};
...
declare module "jassijs_report/RTable" {
    ...
    */
        ...
        initContextMenu(isDatatable: any): any;
        add(component: any): void;
...
declare module "jassijs_report/RTableLayouts" {
    var tableLayouts: {
        ...
        lightHorizontalLines: {
            isSystem: boolean;
            layout: {
                hLineWidth: (i: any, node: any) => 0 | 1 | 2;
                vLineWidth: (i: any, node: any) => number;
            };
        };
        frameWithLines: {
