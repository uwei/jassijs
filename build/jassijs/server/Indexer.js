...
class Indexer {
    async updateModul(root, modul, isserver) {
        ...
        if (await this.fileExists(path + "/registry.js")) {
            ...
            if (isserver && Config_1.config.clientrequire === undefined && Config_1.config.serverrequire === undefined) {
        ...
        if (isserver && Config_1.config.clientrequire === undefined && Config_1.config.serverrequire === undefined) { //nodes
            if (text !== "{}") {
                text = '"use strict:"\n' +
