...
define("jassijs_editor/AcePanel", ["require", "exports", "ace/ace", "jassijs_editor/util/Typescript", "jassijs/remote/Registry", "jassijs/remote/Registry", "jassijs_editor/CodePanel", "jassijs/util/Runlater", "ace/ext/language_tools", "jassijs_editor/Debugger"], function (require, exports, ace_1, Typescript_1, Registry_1, Registry_2, CodePanel_1, Runlater_1) {
    "use strict";
    var AcePanel_1;
...
define("jassijs_editor/util/DragAndDropper", ["require", "exports", "jassijs/remote/Registry", "jquery.ui"], function (require, exports, Registry_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("jassijs_editor/util/Resizer", ["require", "exports", "jassijs/remote/Registry", "jquery.ui"], function (require, exports, Registry_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let Typescript = Typescript_5 = class Typescript {
        ...
        async transpile(fileName, content, compilerSettings = undefined) {
            ...
            if (fileName.toLocaleLowerCase().endsWith(".js")) { //js Code would be not transpiled
                ...
                var opt = {
                    compilerOptions: compilerSettings ? compilerSettings : Typescript_5.compilerSettings,
        ...
        async initService() {
            if (Typescript_5._isInited !== undefined)
                return;
            Typescript_5._isInited = false;
            Typescript_5.initMonaco();
            //@ts-ignore
        ...
        async getDefinitionAtPosition(file, position) {
            ...
            if (Typescript_5._isInited !== true) {
        ...
        async renameFile(oldfile, newfile) {
            ...
            var snap = Typescript_5.languageServiceHost.getScriptSnapshot(newfile);
        }
        /**
