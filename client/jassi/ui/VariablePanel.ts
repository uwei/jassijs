...
export  class VariablePanel extends Panel{
        ...
        async createTable(){
        	var Table=(await import("jassi/ui/Table")).Table
        ...
        updateCache(){
            ...
            function update(key,val){
            	if(val instanceof Component){
            		var comps=undefined;
                	try{
                	    comps=ComponentDescriptor.describe(val.constructor).resolveEditableComponents(val);
                	}catch{
