...
define(["require", "exports", "jassijs/remote/Registry", "jassijs/remote/RemoteObject", "jassijs/remote/RemoteObject", "jassijs/remote/Validator"], function (require, exports, Registry_1, RemoteObject_1, RemoteObject_2, Validator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MyRemoteObject = exports.test = exports.Loch = void 0;
    let Loch = class Loch {
    ...
    Loch = __decorate([
        (0, Registry_1.$Class)("de.remote.Loch")
    ], Loch);
    exports.Loch = Loch;
    async function test() {
        console.log(await new Loch().sayHello("Kurt"));
    }
    exports.test = test;
