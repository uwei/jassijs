...
define(["require", "exports", "remote/jassi/base/DBObject", "remote/jassi/base/Jassi", "jassi/util/DatabaseSchema", "remote/jassi/security/Group"], function (require, exports, DBObject_1, Jassi_1, DatabaseSchema_1, Group_1) {
    "use strict";
    ...
    Right = __decorate([
        ...
        Jassi_1.$Class("remote.jassi.security.Right")
    ], Right);
    exports.Right = Right;
});
