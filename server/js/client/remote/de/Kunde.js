...
const AR_1 = require("remote/de/AR");
const Jassi_1 = require("remote/jassi/base/Jassi");
const DatabaseSchema_1 = require("jassi/util/DatabaseSchema");
require("remote/de/Kunde.ext");
const DBObjectQuery_1 = require("remote/jassi/base/DBObjectQuery");
const Rights_1 = require("remote/jassi/security/Rights");
