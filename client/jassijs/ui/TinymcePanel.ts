...
export class TinymcePanel<T extends HTMLPanelProperties=HTMLPanelProperties> extends DataComponent<T> implements HTMLPanelProperties {
    ...
    render() {
        return jc("div",{
            className: "HTMLPanel mce-content-body",tabIndex: -1,children: [
                jc("div",{ className: "HTMLPanelContent" })
            ]
        });
    }
    ...
    private _initTinymce(editor) {
        ...
        _this.on('focus',function() {
            ...
            if(TinymcePanel.oldeditor) {
                (TinymcePanel.oldeditor.getContainer() as HTMLElement).style.display="none";
            }
        });
    }
    /**
