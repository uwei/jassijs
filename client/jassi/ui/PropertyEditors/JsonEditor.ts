...
@$PropertyEditor(["json"])
@$Class("jassi.ui.PropertyEditors.JsonEditor")
...
class TestProperties {
    ...
    @$Property({ name: "jo", type: "json", componentType: "jassi.ui.PropertyEditorTestProperties2" })
    jo: any;

}
@$Class("jassi.ui.PropertyEditorTestProperties2")
