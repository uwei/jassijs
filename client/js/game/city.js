define(["require", "exports", "game/citydialog", "game/product", "game/Company"], function (require, exports, citydialog_1, product_1, Company_1) {
    "use strict";
    ...
    class City {
            ...
            for (var x = 0; x < product_1.allProducts.length; x++) {
                ...
                for (var y = 0; y < this.companies.length; y++) {
                    if (this.companies[y].productid === x) {
                        val = 2 * Math.round(City.neutralStartPeople * product_1.allProducts[x].dailyConsumtion * City.neutralProductionRate);
                    }
                }
                if (val === 0) {
                    val = Math.round(0.5 * City.neutralStartPeople * product_1.allProducts[x].dailyConsumtion);
                }
        ...
        updateNeutralCompanies() {
            ...
            for (var x = 0; x < this.companies.length; x++) {
                ...
                var totalDailyProduce = Math.round(product_1.allProducts[prod].dailyConsumtion * City.neutralStartPeople * City.neutralProductionRate);
    ...
    function createCities2(count, checkProduction = false) {
        ...
        if (checkProduction) {
            ...
            for (var x = 0; x < product_1.allProducts.length; x++) {
                if (product_1.allProducts[x].distribution > 4 && allids.indexOf(product_1.allProducts[x].id) === -1) {
