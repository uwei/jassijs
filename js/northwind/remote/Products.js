...
__decorate([
    Validator_1.ValidateIsInstanceOf({ type: type => Suppliers_1.Suppliers }),
...
__decorate([
    Validator_1.ValidateIsInstanceOf({ type: c => Categories_1.Categories }),
...
__decorate([
    Validator_1.ValidateIsBoolean(),
    DatabaseSchema_1.Column({ nullable: true }),
    __metadata("design:type", Boolean)
], Products.prototype, "Discontinued", void 0);
Products = __decorate([
    DBObject_1.$DBObject(),
    Registry_1.$Class("northwind.Products"),
