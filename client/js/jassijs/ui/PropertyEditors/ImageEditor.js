        ...
        */
        ...
        async showDialog(onlytest = undefined) {
            if (!this.dialog) {
                ...
                var file = (await new Promise((resolve_1, reject_1) => { require(["jassijs/modul"], resolve_1, reject_1); }).then(__importStar)).default.css["materialdesignicons.min.css"] + "?ooo=9";
