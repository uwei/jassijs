...
define(["require", "exports", "remote/jassi/base/DBObject", "remote/jassi/base/Jassi", "jassi/util/DatabaseSchema", "remote/jassi/security/ParentRight", "remote/jassi/security/User", "remote/jassi/security/Right"], function (require, exports, DBObject_1, Jassi_1, DatabaseSchema_1, ParentRight_1, User_1, Right_1) {
    "use strict";
    ...
    Group = __decorate([
        ...
        Jassi_1.$Class("remote.jassi.security.Group")
    ], Group);
    exports.Group = Group;
});
