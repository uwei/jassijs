    ...
    class Indexer {
        async updateModul(root, modul, isserver) {
            ...
            if (await this.fileExists(path + "/registry.js")) {
                ...
                if (Config_6.config.clientrequire !== undefined || Config_6.config.serverrequire !== undefined) {
                    text = text.substring(text.indexOf("default:") + 8);
                    text = text.substring(0, text.lastIndexOf("}") - 1);
                    text = text.substring(0, text.lastIndexOf("}") - 1);
                }
            ...
            if (Config_6.config.clientrequire === undefined && Config_6.config.serverrequire === undefined) { //nodes
                var text = JSON.stringify(index, undefined, "\t");
                if (text !== "{}") {
                    text = '"use strict:"\n' +
                        "//this file is autogenerated don't modify\n" +
